...
class PortfolioHolding(models.Model):
    ...
    the weighted average buy price used to estimate unrealized gains or losses.
    Paper-trading executions update this model through
    ...
    # Decimal keeps holdings precise enough for fractional paper quantities.
    ...
    def unrealized_pnl(self):
        """Return unrealized profit/loss against the average buy price."""
