...
class OrderForm(forms.ModelForm):
    ...
    filled timestamp are assigned by the execution service so client-submitted
    data cannot bypass balance or holdings checks.
    """
    ...
    class Meta:
        ...
        widgets = {
            # The UI accepts fractional quantities while the service validates
            # affordability and available holdings.
            'quantity': forms.NumberInput(attrs={'class': 'form-control', 'min': '0.000001', 'step': '0.000001'}),
        }

    def __init__(self, *args, **kwargs):
        """Apply Bootstrap classes to dynamically generated select widgets."""
