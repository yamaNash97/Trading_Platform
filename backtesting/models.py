...
class BacktestResult(models.Model):
    ...
    A result belongs to a user and captures the strategy, stock, actual price
    range used, account metrics, and equity curve generated by
    ...
    # Stored as JSON for simple Chart.js rendering on the detail page.
...
class BacktestTrade(models.Model):
    """Individual completed trade generated during a backtest."""
    ...
    # Six decimals allow fractional quantities produced by percentage sizing.
